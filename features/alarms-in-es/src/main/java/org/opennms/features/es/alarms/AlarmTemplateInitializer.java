...
public class AlarmTemplateInitializer extends DefaultTemplateInitializer {

    private static final String TEMPLATE_RESOURCE = "/alarm-template";
    private static final String TEMPLATE_NAME = "alarms";

    public AlarmTemplateInitializer(BundleContext bundleContext, JestClient client, IndexSettings indexSettings) {
        super(bundleContext, client, TEMPLATE_RESOURCE, TEMPLATE_NAME, indexSettings);
    }

    public AlarmTemplateInitializer(JestClient client) {
