...
public class AlarmDocumentDTO {
    ...
    public List<AckStateChangeDTO> getAckStateChanges() {
        return ackStateChanges;
    }

    public void setAckStateChanges(List<AckStateChangeDTO> ackStateChanges) {
        this.ackStateChanges = ackStateChanges;
    }
