...
public class ExtAlarmsMatchers {
    ...
    private static class HasSeverity extends TypeSafeMatcher<AlarmDocumentView> {
        ...
        @Override
        protected boolean matchesSafely(AlarmDocumentView alarm) {
            return Objects.equals(severity, alarm.getSeverity());
        }

        @Override
        protected void describeMismatchSafely(AlarmDocumentView item, Description mismatchDescription) {
    ...
    private static class Acknowledged extends TypeSafeMatcher<AlarmDocumentView> {
        @Override
        protected boolean matchesSafely(AlarmDocumentView alarm) {
