...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-footer text-right">
                <form role="form" method="post" name="notificationStatus" action="admin/updateNotificationStatus">
                    ...
                    %>
                    <label class="control-label">Notification Status:<%if (status.equals("Unknown")) {%>
                        Unknown<% }%></label>
                    &nbsp;
                    <label for="on" class="radio-inline"><input style="margin-top:0px;" type="radio" name="status"
                                                                id="on"
                                                                value="on" <%=("On".equals(status) ? "checked" : "")%> />On</label>
                    <label for="off" class="radio-inline"><input style="margin-top:0px;" type="radio" name="status"
                                                                 id="off"
                                                                 value="off" <%=("Off".equals(status) ? "checked" : "")%> />Off</label>
                    &nbsp;
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <ul class="list-unstyled">
                    <li><a href="admin/manageSnmpCollections.jsp">Configure SNMP Collections and Data Collection
                        Groups</a></li>
    ...
    <div class="col-md-6">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <p>Detailed Documentation on all options can be found on <a title="The OpenNMS Project wiki"
                                                                            href="http://www.opennms.org" target="new">the
                    OpenNMS wiki</a>.
                </p>
                ...
                <p><b>Configure Discovery</b>: Set up the IP addresses (individual addresses and/or ranges) that you
                    want OpenNMS
                ...
                <p><b>Notification Status</b>: Notifications will be sent out only if this setting is switched to
                    <em>On</em>.
                    This is a system-wide setting. As long as this is <em>Off</em>, OpenNMS will not create
                    notifications.
                ...
                <P><B>Configure SNMP Community Names by IP Address</b>: Configure the Community String used in SNMP Data
                    Collection and other SNMP operations. OpenNMS is shipped with a community string of "public".
                    If you have set a different <em>read</em> community on your devices you must put it here to be able
                    to collect data from
                    these devices.
                </P>

                <p><b>Manage and Unmanage Interfaces and Services</b>: <em>Managing</em> an interface or service means
                    that
                    OpenNMS performs tests on this interface or service. If you want to explicitly enable or disable
                    testing you
                    can set that up here. A typical case is if a web server is listening on both an internal and an
                    external interface.
                    If you manage the service on both interfaces, you will get two notifications if it fails. If you
                    want only one,
                ...
                <p><b>OpenNMS Plugin Manager</b>: Manage optional OpenNMS OSGi plugins installed in local and remote
                    Karaf Containers.</p>
